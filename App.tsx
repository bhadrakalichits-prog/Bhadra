...
if (!user) {
    return (
      <div className="login-bg min-h-screen flex flex-col items-center justify-center p-4" style={{fontFamily: "'DM Sans', sans-serif"}}>
        {/* Decorative orbs */}
        <div style={{position:'fixed',top:'-10%',right:'-10%',width:400,height:400,borderRadius:'50%',background:'radial-gradient(circle, rgba(245,166,35,0.12) 0%, transparent 70%)',pointerEvents:'none'}} />
        <div style={{position:'fixed',bottom:'-15%',left:'-5%',width:500,height:500,borderRadius:'50%',background:'radial-gradient(circle, rgba(59,130,246,0.08) 0%, transparent 70%)',pointerEvents:'none'}} />
        
        <div className="login-card w-full animate-in" style={{maxWidth:420, padding:'40px 36px'}}>
          {/* Brand */}
          <div style={{textAlign:'center', marginBottom:32}}>
            <div style={{width:56,height:56,background:'linear-gradient(135deg,#f5a623 0%,#e8921a 100%)',borderRadius:16,display:'flex',alignItems:'center',justifyContent:'center',margin:'0 auto 16px',boxShadow:'0 8px 24px rgba(245,166,35,0.35)'}}>
              <svg width="28" height="28" viewBox="0 0 24 24" fill="white"><path d="M11.5 1L2 6v10l9.5 5 9.5-5V6l-9.5-5zm0 17.5L5 15V8.5l6.5 3.5 6.5-3.5V15l-6.5 3.5z"/></svg>
            </div>
            <div style={{color:'white',fontWeight:800,fontSize:22,letterSpacing:'-0.02em',marginBottom:4}}>Bhadrakali Chits</div>
            <div style={{color:'rgba(255,255,255,0.4)',fontSize:12,fontWeight:500}}>Chit Fund Management System</div>
          </div>

          <form onSubmit={handleLogin} style={{display:'flex',flexDirection:'column',gap:16}}>
            <div>
              <label style={{color:'rgba(255,255,255,0.45)!important',fontSize:'10px!important',fontWeight:'700!important',letterSpacing:'0.08em!important',textTransform:'uppercase!important',marginBottom:6,display:'block'}}>User ID / Member ID</label>
              <input
                type="text"
                required
            ...
            <div>
              <label style={{color:'rgba(255,255,255,0.45)!important',fontSize:'10px!important',fontWeight:'700!important',letterSpacing:'0.08em!important',textTransform:'uppercase!important',marginBottom:6,display:'block'}}>Password</label>
              <input
                type="password"
                required
                ...
                style={{fontSize:14}}
              />
              <p style={{color:'rgba(255,255,255,0.28)',fontSize:10,fontWeight:500,marginTop:6}}>Members: use last 4 digits of your registered mobile number</p>
            </div>
            {loginError && (
              <div style={{background:'rgba(239,68,68,0.15)',border:'1px solid rgba(239,68,68,0.3)',borderRadius:8,padding:'10px 14px',color:'#fca5a5',fontSize:12,fontWeight:600,textAlign:'center'}}>
                {loginError}
              </div>
            )}
            <button
              type="submit"
              style={{width:'100%',padding:'13px',background:'linear-gradient(135deg,#f5a623 0%,#e8921a 100%)',color:'white',fontWeight:800,fontSize:14,borderRadius:10,border:'none',cursor:'pointer',boxShadow:'0 4px 16px rgba(245,166,35,0.4)',marginTop:4,letterSpacing:'0.01em'}}
            >
              Sign In
            </button>
          </form>
        ...
        <div style={{color:'rgba(255,255,255,0.2)',fontSize:11,fontWeight:500,marginTop:24,textAlign:'center'}}>
          Powered by Guntupally Technology Services
        </div>
      </div>
    );
  }
